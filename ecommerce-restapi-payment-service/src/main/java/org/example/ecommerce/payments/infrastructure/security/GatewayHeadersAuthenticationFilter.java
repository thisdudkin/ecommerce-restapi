...
public class GatewayHeadersAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        String userIdHeader = request.getHeader(GatewayHeaders.AUTHENTICATED_USER_ID);
        String userRoleHeader = request.getHeader(GatewayHeaders.AUTHENTICATED_USER_ROLE);
        String tokenTypeHeader = request.getHeader(GatewayHeaders.AUTHENTICATED_TOKEN_TYPE);
        ...
        if (!StringUtils.hasText(userIdHeader)
            || !StringUtils.hasText(userRoleHeader)
            || !StringUtils.hasText(tokenTypeHeader)
            || !GatewayHeaders.ACCESS_TOKEN_TYPE.equalsIgnoreCase(tokenTypeHeader)) {
